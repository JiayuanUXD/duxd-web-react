...
基于 [Ddmc Design](https://ddmc.design/) 的 React UI 组件库。
...
* [Less-loader](https://ddmc.design/react/docs/theme)
* [风格配置平台](https://ddmc.design/themes) - 推荐!

## 可复用的定制化物料 

[物料平台](https://ddmc.design/material/) 提供了一站式的物料管理方案。 沉淀可复用的定制化业务模块, 让效率突破猛进。
...
[npm package](https://www.npmjs.com/package/@ddmc-design/web-react)
...
* [官网](https://ddmc.design/)
* [组件文档](https://ddmc.design/react/components/overview)
* [暗黑模式](https://ddmc.design/react/docs/dark)
* [主题配置](https://ddmc.design/react/docs/theme)
* [Figma 设计资源](https://www.figma.com/file/M66cTiLXHa4SVyZIlfY5Pb/ddmc-Design-System?node-id=7945%3A44563)
* [Awesome Ddmc](https://github.com/ddmc-design/awesome-ddmc)
* [构建插件](https://github.com/ddmc-design/ddmc-plugins)

# 生态

| 项目               | 介绍                                             |
| --------------------- | ------------------------------------------------------- |
| [Vue 组件库] | 基于 [Ddmc Design](https://ddmc.design/) 的 Vue UI 组件库。 |
| [风格配置平台] | 精确到组件级的主题视觉配置平台 |
| [物料平台] | 丰富可共享的业务定制物料，让效率突破猛进 |
| [图标平台] | 一站式图标管理平台 |
| [Ddmc Pro] | 快速构建中后台的前端解决方案 |

[Vue 组件库]: https://ddmc.design/vue/docs/start
[风格配置平台]: https://ddmc.design/themes
[物料平台]: https://ddmc.design/material
[图标平台]: https://ddmc.design/iconbox
