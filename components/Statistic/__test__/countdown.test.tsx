...
describe('Statistic.Countdown', () => {
  it('format', () => {
    ...
    formats.forEach(([format, value]) => {
      ...
      expect(component.find('.ddmc-statistic-value')[0].innerHTML).toBe(value);
      cleanup();
    });
  });
  ...
  it('onFinish', () => {
    ...
    expect(component.find('.ddmc-statistic-value')[0].innerHTML).toBe('00:00:01');
    ...
    expect(component.find('.ddmc-statistic-value')[0].innerHTML).toBe('00:00:00');
  ...
  it('renderFormat correctly', () => {
    function formatTest(format, value, diff) {
      ...
      expect(component.find('.ddmc-statistic-value')[0].innerHTML).toEqual(`${diff}-${value}`);
      cleanup();
    }
