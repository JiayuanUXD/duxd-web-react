...
function getItemStyle(component, index) {
  return component.find('.ddmc-space-item').item(index).style.cssText;
}
...
function checkSize(size?: SpaceSize | SpaceSize[]) {
  ...
  expect(component.find('.ddmc-space-item')).toHaveLength(3);
...
describe('Space', () => {
  ...
  it('align', () => {
    ...
    expect(component.find('.ddmc-space')[0].className).toBe(
      'ddmc-space ddmc-space-horizontal ddmc-space-align-center'
    );
    ...
    expect(component.find('.ddmc-space')[0].className).toBe('ddmc-space ddmc-space-vertical');
    ...
    expect(component.find('.ddmc-space')[0].className).toBe(
      'ddmc-space ddmc-space-vertical ddmc-space-align-start'
    );
  });
