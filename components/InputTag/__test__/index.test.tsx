...
describe('InputTag', () => {
  it('render correctly', () => {
    ...
    expect(wrapper.querySelector('.ddmc-input-tag')).toHaveClass(
      'ddmc-input-tag-disabled',
      'ddmc-input-tag-error',
      'ddmc-input-tag-readonly'
    );
  });
  ...
  it('input correctly', async () => {
    ...
    const eleRoot = wrapper.querySelector('.ddmc-input-tag');

    expect(document.querySelectorAll('.ddmc-tag')).toHaveLength(1);

    fireEvent.focus(eleInput);
    expect(eleRoot).toHaveClass('ddmc-input-tag-focus');
  ...
  it('test contains together allowClear and readOnly and do not show the clear button', () => {
    ...
    expect(component.querySelector('.ddmc-input-tag-clear-icon svg')).toBeFalsy();
  });
  ...
  it('tokenSeparators validate failed', async () => {
    ...
    expect(wrapper.querySelectorAll('.ddmc-tag')).toHaveLength(3);
