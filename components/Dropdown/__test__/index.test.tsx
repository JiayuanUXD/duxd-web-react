...
describe('Dropdown', () => {
  ...
  it('dropdown open correctly', () => {
    ...
    fireEvent.click(wrapper.querySelector('.ddmc-btn') as any);
    jest.runAllTimers();
    expect(document.querySelectorAll('.ddmc-dropdown-menu')).toHaveLength(1);
    expect(document.querySelectorAll('.ddmc-dropdown-menu-item')).toHaveLength(3);
  });
  ...
  it('click menu item', () => {
    ...
    const simulateMenuItemClick = (index: number) => {
      fireEvent.click(document.querySelectorAll('.ddmc-dropdown-menu-item')[index]);
    };
    ...
    fireEvent.click(wrapper.querySelector('.ddmc-btn') as HTMLElement);
  ...
  it('Dropdown.Button mount correctly', () => {
    ...
    expect(wrapper.querySelector('.ddmc-btn-group')).toBeTruthy();
    expect(document.querySelectorAll('.ddmc-btn-disabled')).toHaveLength(2);
  });
});
