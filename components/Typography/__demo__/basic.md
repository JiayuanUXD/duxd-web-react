...
```js
import { Typography } from '@ddmc-design/web-react';
...
const App = () => {
  return (
    <Typography style={{ marginTop: -40 }}>
      ...
      <Title heading={2}>DdmcDesign</Title>
      <Paragraph>
        The DdmcDesign component library defines a set of default particle variables, and a custom
