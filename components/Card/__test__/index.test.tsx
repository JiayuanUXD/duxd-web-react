...
describe('Card', () => {
  ...
  it('Card display correctly', () => {
    ...
    expect(wrapper.querySelector('.ddmc-card-header-title').textContent).toBe('Default Card');
  });

  it('Meta display correctly', () => {
    const wrapper = mountCard(createMeta());
    expect(wrapper.querySelector('.ddmc-card-meta-title').textContent).toBe('Docor');
  });
});
