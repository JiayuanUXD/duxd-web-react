...
describe('Descriptions', () => {
  ...
  it('render different layout correctly', () => {
    ...
    expect(row1.querySelectorAll('.ddmc-descriptions-item-label')).toHaveLength(3);
    expect(row1.querySelectorAll('.ddmc-descriptions-item-value')).toHaveLength(0);

    expect(row2.querySelectorAll('.ddmc-descriptions-item-label')).toHaveLength(0);
    expect(row2.querySelectorAll('.ddmc-descriptions-item-value')).toHaveLength(3);
  });
