...
import { Image, Tooltip, Space} from '@ddmc-design/web-react';
import { IconEye, IconDownload, IconInfoCircle } from '@ddmc-design/web-react/icon';
...
function DemoImage(props) {
  ...
  return (
    <Image
      ...
      description="Present by Ddmc Design"
      actions={[
        <button
          key="1"
