...
describe('Upload', function () {
  ...
  it('initial fileList', async function () {
    ...
    expect(wrapper.find('.ddmc-upload-list-item').item(0)).toHaveClass(
      'ddmc-upload-list-item-done'
    );
  });
  ...
  it('initial fileList', async function () {
    ...
    await act(() => {
      fireEvent.click(items.item(2).querySelector('.ddmc-upload-list-reupload-icon') as any);
    });
