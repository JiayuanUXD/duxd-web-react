...
```js
import { Upload, Card, Modal } from '@ddmc-design/web-react';
import { IconEye, IconDelete } from '@ddmc-design/web-react/icon';
      ...
      <Upload
        ...
        defaultFileList={[
          ...
          },
          {
            uid: '-1',
            name: 'ice.png',
            url: '//p1-ddmc.byteimg.com/tos-cn-i-uwbnlip3yd/3ee5f13fb09879ecb5185e440cef6eb9.png~tplv-uwbnlip3yd-webp.webp',
          },
        ]}
