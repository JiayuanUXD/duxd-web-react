...
import { Upload, Button, Message, Modal, Grid, Slider } from '@ddmc-design/web-react';
import { IconMinus, IconPlus, IconRotateLeft, IconUpload } from '@ddmc-design/web-react/icon';
