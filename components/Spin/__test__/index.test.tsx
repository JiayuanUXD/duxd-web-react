...
describe('Spin', () => {
  ...
  it('loading content correctly', () => {
    ...
    expect(wrapper.find('.ddmc-spin-children').length).toBe(1);
  });
  ...
  it('spin with dot loading', () => {
    ...
    expect(wrapper.find('.ddmc-spin-dot-list').length).toBe(1);
  });
  ...
  it('loading delay', () => {
    ...
    expect(wrapper.find('.ddmc-spin-loading-layer').length).toBe(0);
    jest.runAllTimers();
    expect(wrapper.find('.ddmc-spin-loading-layer').length).toBe(1);
  });
  ...
  it('spin with display:block', () => {
    ...
    expect(wrapper.find('.ddmc-spin-block').length).toBe(1);
  });
