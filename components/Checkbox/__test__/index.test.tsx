...
describe('Checkbox uncontrolled', () => {
  it('Checkbox default check', () => {
    ...
    expect(wrapper.querySelector('.ddmc-checkbox')).toHaveClass('ddmc-checkbox-checked');
  });

  it('Checkbox onChange', () => {
    const mockFn = jest.fn();
    const wrapper = render(<Checkbox onChange={mockFn}>Checkbox</Checkbox>);
    fireEvent.click(wrapper.querySelector('.ddmc-checkbox'), {
      target: {
        checked: true,
      },
    });
...
describe('Checkbox controlled', () => {
  ...
  it('Checkbox onChange', () => {
    ...
    expect(wrapper.querySelector('.ddmc-checkbox-checked')).toBe(null);
  });
});
...
describe('Checkbox Custom Icon', () => {
  it('custom icon is not element', () => {
    ...
    const mask = wrapper.querySelector('.ddmc-checkbox-mask')!;
