...
import { Table } from '@ddmc-design/web-react';
import { IconDragDotVertical } from '@ddmc-design/web-react/icon';
...
function App() {
  ...
  const DraggableContainer = (props) => (
    <SortableWrapper
      useDragHandle
      onSortEnd={onSortEnd}
      helperContainer={() => document.querySelector('.ddmc-drag-table-container-2 table tbody')}
  ...
  return (
    <Table
      className="ddmc-drag-table-container-2"
