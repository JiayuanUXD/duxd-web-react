...
describe('Table special case test', () => {
  ...
  it('data item is array', () => {
    // case: https://github.com/ddmc-design/ddmc-design/issues/1258
    const columns = [
      {
        dataIndex: '[0]',
        title: 'title',
  ...
  it('data item is number or string', () => {
    // case https://github.com/ddmc-design/ddmc-design/issues/1608
    const columns = [
      {
        title: 'title',
  ...
  it('change data and selectedRows should up-to-date', () => {
    // case: https://github.com/ddmc-design/ddmc-design/issues/1294
    const columns = [
      {
        dataIndex: 'title',
        title: 'title',
