...
describe('Table ignore undefined sortOrder', () => {
  ...
  it('should not apply default sorting when sortOrder is undefined', () => {
    ...
    const getFirstAge = () => {
      return component.find('tbody tr').item(0).querySelectorAll('td .ddmc-table-cell').item(1)
        .textContent;
    };
  ...
  it('should skip sorters with undefined direction in compareFn', () => {
    ...
    const getFirstName = () => {
      return component.find('tbody tr').item(0).querySelectorAll('td .ddmc-table-cell').item(0)
        .textContent;
    };
