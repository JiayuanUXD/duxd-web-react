...
describe('Table fixed columns', () => {
  it('basic fixed columns', () => {
    ...
    expect(
      component.find('th.ddmc-table-col-fixed-left.ddmc-table-col-fixed-left-last')
    ).toHaveLength(1);
    expect(
      component.find('th.ddmc-table-col-fixed-right.ddmc-table-col-fixed-right-first')
    ).toHaveLength(1);

    expect(
      component.find('td.ddmc-table-col-fixed-left.ddmc-table-col-fixed-left-last')
    ).toHaveLength(5);
    expect(
      component.find('td.ddmc-table-col-fixed-right.ddmc-table-col-fixed-right-first')
    ).toHaveLength(5);
    ...
    expect(getHeadCell(0).className).toBe(
      'ddmc-table-th ddmc-table-col-first ddmc-table-col-fixed-left ddmc-table-col-fixed-left-last'
    );
    expect(getHeadCell(0).getAttribute('style')).toEqual('left: 0px;');

    expect(getBodyCell(0).className).toBe(
      'ddmc-table-td ddmc-table-col-fixed-left ddmc-table-col-fixed-left-last ddmc-table-col-first'
    );
  ...
  it('only fixed selection', () => {
    ...
    expect(component.find('th.ddmc-table-col-fixed-left')).toHaveLength(2);

    expect(component.find('td.ddmc-table-col-fixed-left')).toHaveLength(10);
    ...
    expect(getHeadCell(0).className).toBe(
      'ddmc-table-th ddmc-table-operation ddmc-table-expand ddmc-table-col-fixed-left'
    );
    expect(getHeadCell(0).getAttribute('style')).toEqual('left: 0px;');

    expect(getHeadCell(1).className).toBe(
      'ddmc-table-th ddmc-table-operation ddmc-table-checkbox ddmc-table-col-fixed-left ddmc-table-col-fixed-left-last'
    );
    expect(getHeadCell(1).getAttribute('style')).toEqual('left: 40px;');

    expect(getBodyCell(0).className).toBe(
      'ddmc-table-td ddmc-table-operation ddmc-table-expand-icon-cell ddmc-table-col-first ddmc-table-col-fixed-left ddmc-table-col-first'
    );
    expect(getBodyCell(0).getAttribute('style')).toEqual('left: 0px;');

    expect(getBodyCell(1).className).toBe(
      'ddmc-table-td ddmc-table-operation ddmc-table-checkbox ddmc-table-col-fixed-left ddmc-table-col-fixed-left-last'
    );
  ...
  it('fixed columns and fixed header', () => {
    ...
    expect(component.find('.ddmc-table-header table')).toHaveLength(1);
    expect(component.find('.ddmc-table-body table')).toHaveLength(1);
  });
  ...
  it('update columns', () => {
    ...
    expect(getHeadCell(component, 0).className).toBe('ddmc-table-th ddmc-table-col-first');
    expect(getHeadCell(component, 0).getAttribute('style')).toEqual(null);
    expect(getHeadCell(component, 1).className).toBe('ddmc-table-th');
    expect(getHeadCell(component, 1).getAttribute('style')).toEqual(null);

    expect(getBodyCell(component, 0).className).toBe('ddmc-table-td ddmc-table-col-first');
    expect(getBodyCell(component, 0).getAttribute('style')).toEqual(null);
    expect(getBodyCell(component, 1).className).toBe('ddmc-table-td');
  ...
  it('fixed columns with string width', () => {
    ...
    expect(getHeadCell(3).className).toBe(
      'ddmc-table-th ddmc-table-col-fixed-right ddmc-table-col-fixed-right-first'
    );
    expect(getHeadCell(3).getAttribute('style')).toEqual('right: 120px;');

    expect(getBodyCell(3).className).toBe(
      'ddmc-table-td ddmc-table-col-fixed-right ddmc-table-col-fixed-right-first'
    );
    expect(getBodyCell(3).getAttribute('style')).toEqual('right: 120px;');

    expect(getHeadCell(4).className).toBe('ddmc-table-th ddmc-table-col-fixed-right');
    expect(getHeadCell(4).getAttribute('style')).toEqual('right: 0px;');

    expect(getBodyCell(4).className).toBe('ddmc-table-td ddmc-table-col-fixed-right');
