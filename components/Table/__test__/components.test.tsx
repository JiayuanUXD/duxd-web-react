...
describe('Table components', () => {
  ...
  it('Table custom operations selectionNode with tooltip', () => {
    ...
    fireEvent.mouseEnter(component.find('thead .ddmc-table-checkbox')[0]);
    jest.runAllTimers();

    expect(component.find('thead .ddmc-table-checkbox')[0].className).toBe(
      'ddmc-table-th ddmc-table-operation ddmc-table-checkbox ddmc-tooltip-open'
    );
    fireEvent.mouseEnter(component.find('tbody .ddmc-table-checkbox').item(0));
    jest.runAllTimers();

    expect(component.find('tbody .ddmc-table-checkbox').item(0).className).toBe(
      'ddmc-table-td ddmc-table-operation ddmc-table-checkbox ddmc-table-col-first ddmc-tooltip-open'
    );
  });
