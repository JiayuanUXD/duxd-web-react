...
describe('YearPicker', () => {
  it('defaultValue & today', async () => {
    ...
    fireEvent.click(component.find('.ddmc-picker-date').item(6));

    expect(component.find('.ddmc-picker-start-time')[0].getAttribute('value')).toBe('2025');
  });
  ...
  it('allowClear', () => {
    ...
    expect(component.find('.ddmc-picker-start-time')[0].getAttribute('value')).toBe('2020');
