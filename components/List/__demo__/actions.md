...
import { IconEdit, IconDelete, IconDown, IconLoading } from '@ddmc-design/web-react/icon';
    ...
    >
      {loading ? (
        <span style={{ color: 'var(--color-text-3)' }}>
          <IconLoading style={{ marginRight: 8, color: 'rgb(var(--ddmcgreen-6))' }} />
          loading...
        </span>
      ) : (
...
.list-demo-actions .ddmc-list-item-action li:not(:last-child) .list-demo-actions-button::after {
  content: '';
  position: absolute;
  top: 3px;
  right: -10px;
