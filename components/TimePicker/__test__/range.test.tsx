...
describe('TimePicker.RangePicker', () => {
  it('basic', () => {
    ...
    fireEvent.click(component.find('.ddmc-picker-range')[0]);

    expect(component.find('.ddmc-timepicker')).toHaveLength(1);

    expect(component.find('.ddmc-timepicker-footer-btn-wrapper button')).toHaveLength(1);
