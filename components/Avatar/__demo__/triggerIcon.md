...
```js
import { Avatar, Message, Space } from '@ddmc-design/web-react';
import { IconUser, IconCamera, IconEdit, IconClose } from '@ddmc-design/web-react/icon';
  ...
  return (
    <Space size="large">
      ...
      <Avatar triggerIcon={<IconCamera />} triggerType="mask">
        <img
          alt="avatar"
          src="//p1-ddmc.byteimg.com/tos-cn-i-uwbnlip3yd/3ee5f13fb09879ecb5185e440cef6eb9.png~tplv-uwbnlip3yd-webp.webp"
        />
      </Avatar>
    </Space>
  );
