...
```js
import { Avatar, Space } from '@ddmc-design/web-react';

const App = () => {
  return (
    <Space size="large" direction="vertical">
      <Space size="large">
        <Avatar size={64}>Ddmc</Avatar>
        <Avatar size={40}>Ddmc</Avatar>
        <Avatar size={32}>Ddmc</Avatar>
        <Avatar size={24}>Ddmc</Avatar>
      </Space>
      <Space size="large">
