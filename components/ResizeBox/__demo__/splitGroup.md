...
import { ResizeBox, Typography } from '@ddmc-design/web-react';
import { IconDoubleLeft, IconDoubleRight } from '@ddmc-design/web-react/icon';
...
.resizebox-split-group-demo-trigger .ddmc-resizebox-trigger-icon {
  color: #ffffff;
}
