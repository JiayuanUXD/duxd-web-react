...
const triggerPrefixCls = 'ddmc-resizebox-trigger';

const groupPrefixCls = 'ddmc-resizebox-split-group';
...
describe('ResizeBox Split Group', () => {
  ...
  it('render direction vertical correctly', () => {
    ...
    expect(wrapper.find('.ddmc-typography')).toHaveLength(2);
  ...
  it('handle collapsed correctly', () => {
    ...
    expect(wrapper.find('.ddmc-typography')).toHaveLength(panes.length);
  ...
  it('render customer icon and trigger correctly', () => {
    ...
    expect(wrapper.find('.ddmc-btn .ddmc-icon-plus')).toHaveLength(1);
  });
});
