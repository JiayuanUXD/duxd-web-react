...
describe('ResizeBox', () => {
  ...
  it('render without props correctly', () => {
    ...
    expect(wrapper.find('.ddmc-resizebox-trigger')[0].classList).toContain(
      'ddmc-resizebox-direction-right'
    );
  });
  ...
  it('handle right change correctly', () => {
    ...
    act(() => {
      fireEvent(
        wrapper.find('.ddmc-resizebox-trigger')[0],
    ...
    expect(wrapper.find('.ddmc-resizebox')[0].style.width).toEqual('200px');
    expect(wrapper.find('.ddmc-resizebox')[0].style.height).toEqual('100px');
  ...
  it('handle bottom change correctly', () => {
    ...
    expect(wrapper.find('.ddmc-resizebox')[0].style.width).toEqual('100px');
    expect(wrapper.find('.ddmc-resizebox')[0].style.height).toEqual('300px');
  });
  ...
  it('render basic split correctly', () => {
    ...
    expect(wrapper.find('.ddmc-resizebox-split-pane')).toHaveLength(2);
    expect(wrapper.find('.ddmc-resizebox-trigger')).toHaveLength(1);
    expect(wrapper.find('.ddmc-resizebox-trigger')[0].classList).toContain(
      'ddmc-resizebox-trigger-vertical'
    );
  });
  ...
  it('use in Layout correctly', () => {
    ...
    expect(wrapper.find('.ddmc-resizebox')[0].classList).toContain('ddmc-layout-sider');
  });
  ...
  it('render direction reverse correctly', () => {
    ...
    expect(wrapper.find('.ddmc-resizebox-split-pane .ddmc-typography')[0].innerHTML).toEqual(
      'Left'
    );
    expect(wrapper.find('.ddmc-resizebox-split-pane .ddmc-typography')[1].innerHTML).toEqual(
      'Right'
    );
