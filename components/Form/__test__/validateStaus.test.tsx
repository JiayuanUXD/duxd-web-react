...
describe('form validate status', () => {
  it('success', async () => {
    ...
    expect(wrapper.find('.ddmc-form-item')[0]).toHaveClass('ddmc-form-item-status-success');
  });
  it('error', async () => {
    const wrapper = mountForm(
      <Form>
    ...
    expect(wrapper.find('.ddmc-form-item')[0]).toHaveClass('ddmc-form-item-status-error');
  });
  it('warning', async () => {
    const wrapper = mountForm(
      <Form>
    ...
    expect(wrapper.find('.ddmc-form-item')[0]).toHaveClass('ddmc-form-item-status-warning');
  });
  ...
  it('help', async () => {
    ...
    expect(wrapper.find('.ddmc-form-message')[0]).toHaveClass('ddmc-form-message-help');
  });
