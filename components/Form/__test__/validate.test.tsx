...
describe('validate form', () => {
  ...
  it('validateLevel in rules', async () => {
    ...
    expect(wrapper.querySelector('.ddmc-form-message')?.innerHTML).toBe(
      '<div role="alert">字符数最少为 6</div><div role="alert" class="ddmc-form-message-help-warning">url 不是合法的邮箱地址</div>'
    );
    expect(wrapper.find('.ddmc-form-message-help-warning')).toHaveLength(1); // warning 信息
    ...
    expect(wrapper.find('.ddmc-form-item-status-error')).toHaveLength(0);
    expect(wrapper.find('.ddmc-form-message-help-warning')).toHaveLength(1);
    ...
    expect(wrapper.find('.ddmc-form-message-help-warning')[0].textContent).toBe('hahahaha');
  });
  ...
  it('validate messages', async () => {
    ...
    expect(wrapper.find('.ddmc-form-message')[0].children[0].textContent).toBe('字符数必须是 3');
    ...
    expect(wrapper.find('.ddmc-form-message')[0].children[0].textContent).toBe('必须填写 Username');
    ...
    expect(wrapper.find('.ddmc-form-message')[0].children[0].textContent).toBe('不匹配正则 /abc/');
  });
  ...
  it('validateonly', async () => {
    ...
    expect(wrapper.find('.ddmc-form-message')).toHaveLength(0);
    ...
    expect(wrapper.find('.ddmc-form-message')).toHaveLength(1);
  });
});
