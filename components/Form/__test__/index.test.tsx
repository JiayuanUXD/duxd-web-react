...
describe('Form test', () => {
  it('basic form', () => {
    ...
    const labels = component.find(
      '.ddmc-form-item .ddmc-form-label-item.ddmc-col.ddmc-col-5 label'
    );
    const contents = component.find('.ddmc-form-item .ddmc-form-item-wrapper.ddmc-col.ddmc-col-19');
  ...
  it('formatter form', () => {
    ...
    const cells = wrapper.find('.ddmc-picker-cell-in-view');
