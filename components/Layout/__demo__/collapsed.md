...
import { Layout, Menu, Breadcrumb, Button, Message } from '@ddmc-design/web-react';
import { IconHome, IconCalendar, IconCaretRight, IconCaretLeft } from '@ddmc-design/web-react/icon';
...
.layout-collapse-demo .ddmc-layout-sider .logo {
  height: 32px;
  margin: 12px 8px;
  background: rgba(255, 255, 255, 0.2);
}

.layout-collapse-demo .ddmc-layout-sider-light .logo {
  background: var(--color-fill-2);
}

.layout-collapse-demo .ddmc-layout-footer,
.layout-collapse-demo .ddmc-layout-content {
...
.layout-collapse-demo .ddmc-layout-header {
  height: 64px;
  line-height: 64px;
  background: var(--color-bg-3);
}

.layout-collapse-demo .ddmc-layout-header .trigger {
  margin-left: 20px;
}
```
