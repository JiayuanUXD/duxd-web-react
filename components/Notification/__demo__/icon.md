...
```js
import { Notification, Button, Icon, Space } from '@ddmc-design/web-react';
import { IconFaceSmileFill } from '@ddmc-design/web-react/icon';
      ...
      <Button
        onClick={() =>
          Notification.info({
            ...
            title: 'Upgrade',
            content: 'Ready to upgrade DdmcDesign 2.0',
          })
        }
        type="primary"
      ...
      <Button
        onClick={() =>
          Notification.success({
            ...
            title: 'Success',
            content: 'DdmcDesign 2.0 upgrade completed!',
          })
        }
        type="primary"
        status="success"
      ...
      <Button
        onClick={() =>
          Notification.error({
            ...
            title: 'Error',
            content: 'Failed to upgrade DdmcDesign 2.0!',
          })
        }
        type="primary"
        status="danger"
