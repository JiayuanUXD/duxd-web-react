...
const getInputValue = (wrapper, index?: number) => {
  return wrapper.find('.ddmc-input').item(index ?? 0).value;
};

describe('InputNumber ', () => {
  it('init value correctly', () => {
    const wrapper = render(<InputNumber defaultValue={8} min={0} max={15} />);
    const input = wrapper.find<HTMLInputElement>('.ddmc-input')[0];
  ...
  it('plus correctly', () => {
    ...
    const plusButton = wrapper.find('.ddmc-input-number-step-button').item(0);
  ...
  it('minus correctly', () => {
    const wrapper = render(<InputNumber min={0} max={15} />);
    const buttons = wrapper.find('.ddmc-input-number-step-button');
  ...
  describe('formatter', () => {
    ...
    it('formatter on keydown', () => {
      ...
      const input = wrapper.find('.ddmc-input')[0];
      fireEvent.keyDown(input, { keyCode: ArrowDown.code });
  ...
  it('big decimal', () => {
    ...
    fireEvent.mouseDown(wrapper.querySelectorAll('.ddmc-input-number-step-button')[1]);
