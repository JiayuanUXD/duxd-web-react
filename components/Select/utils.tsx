...
function isSelectOption(child): boolean {
  return get(child, 'props.isSelectOption') || get(child, 'type.__DDMC_SELECT_OPTION__');
}

function isSelectOptGroup(child): boolean {
  return get(child, 'props.isSelectOptGroup') || get(child, 'type.__DDMC_SELECT_OPTGROUP__');
}
