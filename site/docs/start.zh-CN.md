...
<ACCard
  title="DdmcPro 最佳实践"
  description="使用 DdmcPro，快速构建现代网页。"
...
* 开发环境: https://unpkg.com/@ddmc-design/web-react@latest/dist/ddmc.development.js
* 生产环境: https://unpkg.com/@ddmc-design/web-react@latest/dist/ddmc.min.js
  * 图标: https://unpkg.com/@ddmc-design/web-react@latest/dist/ddmc-icon.min.js
  * 样式: https://unpkg.com/@ddmc-design/web-react@latest/dist/css/ddmc.min.css
...
`@ddmc-design/web-react` 的组件默认支持 `tree shaking`, 使用 `import { Button } from '@ddmc-design/web-react';` 方式引入即可按需加载。

如果`按需加载失效`，或者需要`样式按需加载`以及`图标按需加载`的可使用以下两种方式处理：

### 使用 Ddmc 官方插件

`Ddmc` 的 [官方插件库](https://github.com/ddmc-design/ddmc-plugins) 提供的插件功能如下：
...
> 具体使用方式请点击插件链接到详情页中查看
  ...
  - [@ddmc-plugins/unplugin-react 🚧](https://github.com/ddmc-design/ddmc-plugins/blob/main/packages/unplugin-react/README.zh-CN.md) 适用于包括 Rspack 在内多种 Bundler 的 Unplugin 插件
  - [@ddmc-plugins/webpack-react](https://github.com/ddmc-design/ddmc-plugins/blob/main/packages/plugin-webpack-react/README.zh-CN.md) 适用于 Ddmc react 组件的 webpack 插件
  - [@ddmc-plugins/vite-react](https://github.com/ddmc-design/ddmc-plugins/blob/main/packages/plugin-vite-react/README.zh-CN.md) 适用于 Ddmc react 组件库的 vite 插件
  - [@ddmc-plugins/vite-vue](https://github.com/ddmc-design/ddmc-plugins/blob/main/packages/plugin-vite-vue/README.zh-CN.md) 适用于 Ddmc vue 组件库的 vite 插件
