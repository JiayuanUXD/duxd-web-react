...
```
GET https://ddmc.design/material/api/group
...
```
POST https://ddmc.design/material/api/group
...
```
POST https://ddmc.design/material/api/group/queryGroupSite
...
```
POST https://ddmc.design/material/api/group/queryGroupSiteOutline
