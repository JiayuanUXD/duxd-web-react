...
Ddmc Design Lab is a design system configuration platform aimed at improving design and development efficiency. By assisting companies to build a personalized design system to help companies better manage the design system and improve the efficiency of the entire process of product design.
`````
...
In [Platform Home Page](https://ddmc.design/themes), you can quickly create your own design system, which is displayed as the design style of Ddmc Design by default.
...
![](https://p1-ddmc.byteimg.com/tos-cn-i-uwbnlip3yd/ee4f22faa9994671b8f192317d391e03~tplv-uwbnlip3yd-image.image)
...
![](https://p1-ddmc.byteimg.com/tos-cn-i-uwbnlip3yd/70bb3fe82ea142a6bcfef2f4217191c0~tplv-uwbnlip3yd-image.image)

DdmcDesign defaults to the component sizes as mini(24px), small(28px), default(32px), large(36px). If you need to modify the global size, you can directly modify the relevant configuration of the component size in the `Size` menu to quickly achieve the desired effect.
...
![](https://p1-ddmc.byteimg.com/tos-cn-i-uwbnlip3yd/1f2d859b8c344dc3b5bb4d9e61b3ae44~tplv-uwbnlip3yd-image.image)
...
![](https://p1-ddmc.byteimg.com/tos-cn-i-uwbnlip3yd/8313ab1e0cc844ec8329b0b5c1149638~tplv-uwbnlip3yd-image.image)
...
![](https://p1-ddmc.byteimg.com/tos-cn-i-uwbnlip3yd/4cf6a94e67c9491f80587fc406c087c7~tplv-uwbnlip3yd-image.image)
