...
const imageList = {
  byted_effects:
    'http://p1-ddmc.byteimg.com/tos-cn-i-uwbnlip3yd/showcase-byted-effects~tplv-uwbnlip3yd-png.png',
  starry: 'http://p1-ddmc.byteimg.com/tos-cn-i-uwbnlip3yd/showcase-starry~tplv-uwbnlip3yd-png.png',
  volc_engine:
    'http://p1-ddmc.byteimg.com/tos-cn-i-uwbnlip3yd/showcase-volc-engine.png~tplv-uwbnlip3yd-png.png',
  volc_translate:
    'http://p1-ddmc.byteimg.com/tos-cn-i-uwbnlip3yd/show-case-volc-translate.png~tplv-uwbnlip3yd-png.png',
  toutiao:
    'http://p1-ddmc.byteimg.com/tos-cn-i-uwbnlip3yd/showcase-toutiao~tplv-uwbnlip3yd-png.png',
  feilian:
    'http://p1-ddmc.byteimg.com/tos-cn-i-uwbnlip3yd/showcase-feilian.png~tplv-uwbnlip3yd-png.png',
  volc_live:
    'http://p1-ddmc.byteimg.com/tos-cn-i-uwbnlip3yd/showcase-volc-live~tplv-uwbnlip3yd-png.png',
  volc_translive:
    'http://p1-ddmc.byteimg.com/tos-cn-i-uwbnlip3yd/showcase-volc-translive.png~tplv-uwbnlip3yd-png.png',
};
  ...
  const data: ShowCaseCardProps[] = [
    {
      ...
      content: isEn ? (
        <div>
          Through <mark>Ddmc design lab</mark> and <mark>iconbox</mark>, Volcengine generates a
        ...
        <div>
          通过<mark>ddmc风格配置平台</mark>和<mark>IconBox图标平台</mark>
    ...
    },
    {
      ...
      content: isEn ? (
        <div>
          With <mark>Ddmc's flexible and comprehensive component resources</mark>, Toutiao quickly
    ...
    },
    {
      ...
      content: isEn ? (
        <div>
          Based on <mark>Ddmc's youthful color</mark> and <mark>component design</mark>, Feilian
        ...
        <div>
          基于<mark>ddmc年轻化的色彩</mark>和<mark>组件设计</mark>
    ...
    },
    {
      ...
      content: isEn ? (
        <div>
          With <mark>Ddmc's own icons and brand resources</mark>, Volctrans lands the design work of
    ...
    },
    {
      ...
      content: isEn ? (
        <div>
          Based on <mark>Ddmc's comprehensive page layouts</mark> and
        ...
        <div>
          基于ddmc<mark>多样的页面布局</mark>及<mark>样式设置能力</mark>
    ...
    },
    {
      ...
      content: isEn ? (
        <div>
          Use <mark>Ddmc Mobile's custom components and development framework </mark>, BytedEffects
        ...
        <div>
          使用<mark>ddmc mobile的定制组件与开发框架</mark>
    ...
    },
    {
      ...
      content: isEn ? (
        <div>
          Based on <mark>the strong interactive capabilities of Ddmc components</mark>, Starry
    ...
    },
    {
      ...
      content: isEn ? (
        <div>
          Based on <mark>the lightweight framework powered by Ddmc</mark>, Volctrans SI achieves the
