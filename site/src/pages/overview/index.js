...
import { Typography, Grid } from '@ddmc-design/web-react';
import { IconRight } from '@ddmc-design/web-react/icon';
...
const locale = {
  'zh-CN': {
    overview: '组件索引',
    description: 'DdmcDesign 提供了丰富的组件，在这里你可以非常直观的找到它们。',
    component: '组件',
    general: '通用',
  },
  'en-US': {
    overview: 'Overview',
    description:
      'DdmcDesign provides a wealth of components, where you can find them very intuitively.',
    component: 'Component',
    general: 'General',
  },
};
