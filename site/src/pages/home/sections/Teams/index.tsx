...
import { Divider, Button, Carousel, Space } from '@ddmc-design/web-react';
import { IconClose } from '@ddmc-design/web-react/icon';
import { teaLog } from '@ddmc-materials/site-utils';
import LogoDdmc from '../../assets/logo_DdmcDesign.svg';
import LogoDarkDdmc from '../../assets/logo_dark_DdmcDesign.svg';
...
const reviews = [
  {
    name: 'YangYu',
    position: '前端开发',
    content: 'Ddmc 的`文档`写得挺清晰的，还有问题响应速度和 API 会让我用的比较舒服。',
  },
  {
    name: 'MuXin',
    position: '设计师',
  ...
  },
  {
    ...
    position: '产品经理',
    content:
      'Ddmc 会给我`更年轻`的那种感觉，优点的话，我感觉就要比其他的方便一些。就公司内部来说吧，就是`响应会更及时`，然后提出一些问题解决的也会比较快。',
  },
  {
    name: 'Richie Xu',
    position: '前端开发',
  ...
  },
  {
    name: 'ChuYi',
    position: '前端开发',
    content: '`反馈渠道`蛮好的，跟 Ddmc 开发同学直接反馈，修复也比较快。',
  },
  {
    name: 'JiaAn',
    position: '产品经理',
      ...
      <div className={styles['section-content']}>
        <div className={styles['teams-body-left']}>
          <div className={styles['teams-logo']}>
            {realTheme === 'dark' ? <LogoDarkDdmc /> : <LogoDdmc />}
