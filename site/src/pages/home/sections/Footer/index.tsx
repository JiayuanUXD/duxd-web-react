    ...
    <div className={styles['section-wrapper']}>
      <div className={styles['footer-item']}>
        ...
        <div className={styles['footer-item-content']}>
          <a className={styles['footer-item-name']} href={linkDocsDdmcComponent}>
