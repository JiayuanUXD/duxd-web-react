export default {
  ...
  'ecosystem.item.BrandStore.desc': 'Ddmc 生态下汇集字节跳动旗下众多品牌资源的平台',
  ...
  'ecosystem.item.DdmcPro.alias': '中后台最佳实践',
  'ecosystem.item.DdmcPro.slogan': '开箱即用的中后台前端解决方案',
  'ecosystem.item.DdmcPro.desc': '设计/前端工程化，快速构建现代网页',
