...
import { linkFigmaDdmcComponent } from '../../constant/links';
...
export default function QuickStart() {
  ...
  const renderCodeContent = () => {
    return (
      <CodeCopy
        code={'npm i <span class="token-package">@ddmc-design/web-react</span>'}
        copyText="npm i @ddmc-design/web-react"
      />
    );
  };
